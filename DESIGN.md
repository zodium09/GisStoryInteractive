...
- เนื้อหาทุกบทมีลำดับแบบตำราและอ่านต่อเนื่องได้โดยไม่ต้องเลือกโหมด
...
- **Style:** ป้าย pill ใช้กับตัวกรองและ metadata สั้นเท่านั้น
...
- **Do** วางนิยาม กระบวนการ หลักฐาน และกรณีศึกษาในลำดับเดียวกันทุกบท
